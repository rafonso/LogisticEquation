...
public class SliderSpinnerBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( logisticequation.ui.components.SliderSpinner.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_intervals = 55;
    ...
    private static final int PROPERTY_pattern = 81;
    ...
    private static final int PROPERTY_sliderPosition = 91;
    private static final int PROPERTY_step = 92;
    private static final int PROPERTY_titulo = 93;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", logisticequation.ui.components.SliderSpinner.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", logisticequation.ui.components.SliderSpinner.class, "getActionMap", null ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", logisticequation.ui.components.SliderSpinner.class, "getAlignmentX", null ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", logisticequation.ui.components.SliderSpinner.class, "getAlignmentY", null ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", logisticequation.ui.components.SliderSpinner.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", logisticequation.ui.components.SliderSpinner.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", logisticequation.ui.components.SliderSpinner.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", logisticequation.ui.components.SliderSpinner.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", logisticequation.ui.components.SliderSpinner.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", logisticequation.ui.components.SliderSpinner.class, "getBorder", null ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", logisticequation.ui.components.SliderSpinner.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", logisticequation.ui.components.SliderSpinner.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", logisticequation.ui.components.SliderSpinner.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", logisticequation.ui.components.SliderSpinner.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", logisticequation.ui.components.SliderSpinner.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", logisticequation.ui.components.SliderSpinner.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", logisticequation.ui.components.SliderSpinner.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", logisticequation.ui.components.SliderSpinner.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", logisticequation.ui.components.SliderSpinner.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", logisticequation.ui.components.SliderSpinner.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", logisticequation.ui.components.SliderSpinner.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", logisticequation.ui.components.SliderSpinner.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", logisticequation.ui.components.SliderSpinner.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", logisticequation.ui.components.SliderSpinner.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", logisticequation.ui.components.SliderSpinner.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", logisticequation.ui.components.SliderSpinner.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_extendedStep] = new PropertyDescriptor ( "extendedStep", logisticequation.ui.components.SliderSpinner.class, "getExtendedStep", "setExtendedStep" ); // NOI18N
            properties[PROPERTY_extendedStep].setPreferred ( true );
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", logisticequation.ui.components.SliderSpinner.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", logisticequation.ui.components.SliderSpinner.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", logisticequation.ui.components.SliderSpinner.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", logisticequation.ui.components.SliderSpinner.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", logisticequation.ui.components.SliderSpinner.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", logisticequation.ui.components.SliderSpinner.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", logisticequation.ui.components.SliderSpinner.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", logisticequation.ui.components.SliderSpinner.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", logisticequation.ui.components.SliderSpinner.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", logisticequation.ui.components.SliderSpinner.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", logisticequation.ui.components.SliderSpinner.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", logisticequation.ui.components.SliderSpinner.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", logisticequation.ui.components.SliderSpinner.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", logisticequation.ui.components.SliderSpinner.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", logisticequation.ui.components.SliderSpinner.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", logisticequation.ui.components.SliderSpinner.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", logisticequation.ui.components.SliderSpinner.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", logisticequation.ui.components.SliderSpinner.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", logisticequation.ui.components.SliderSpinner.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", logisticequation.ui.components.SliderSpinner.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", logisticequation.ui.components.SliderSpinner.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", logisticequation.ui.components.SliderSpinner.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", logisticequation.ui.components.SliderSpinner.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", logisticequation.ui.components.SliderSpinner.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", logisticequation.ui.components.SliderSpinner.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", logisticequation.ui.components.SliderSpinner.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", logisticequation.ui.components.SliderSpinner.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", logisticequation.ui.components.SliderSpinner.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_intervals] = new PropertyDescriptor ( "intervals", logisticequation.ui.components.SliderSpinner.class, "getIntervals", "setIntervals" ); // NOI18N
            properties[PROPERTY_intervals].setPreferred ( true );
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", logisticequation.ui.components.SliderSpinner.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", logisticequation.ui.components.SliderSpinner.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", logisticequation.ui.components.SliderSpinner.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", logisticequation.ui.components.SliderSpinner.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", logisticequation.ui.components.SliderSpinner.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", logisticequation.ui.components.SliderSpinner.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", logisticequation.ui.components.SliderSpinner.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximum] = new PropertyDescriptor ( "maximum", logisticequation.ui.components.SliderSpinner.class, "getMaximum", "setMaximum" ); // NOI18N
            properties[PROPERTY_maximum].setPreferred ( true );
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", logisticequation.ui.components.SliderSpinner.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", logisticequation.ui.components.SliderSpinner.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimum] = new PropertyDescriptor ( "minimum", logisticequation.ui.components.SliderSpinner.class, "getMinimum", "setMinimum" ); // NOI18N
            properties[PROPERTY_minimum].setPreferred ( true );
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", logisticequation.ui.components.SliderSpinner.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", logisticequation.ui.components.SliderSpinner.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", logisticequation.ui.components.SliderSpinner.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", logisticequation.ui.components.SliderSpinner.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", logisticequation.ui.components.SliderSpinner.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", logisticequation.ui.components.SliderSpinner.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", logisticequation.ui.components.SliderSpinner.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", logisticequation.ui.components.SliderSpinner.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", logisticequation.ui.components.SliderSpinner.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", logisticequation.ui.components.SliderSpinner.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_orientation] = new PropertyDescriptor ( "orientation", logisticequation.ui.components.SliderSpinner.class, "getOrientation", "setOrientation" ); // NOI18N
            properties[PROPERTY_orientation].setPreferred ( true );
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", logisticequation.ui.components.SliderSpinner.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", logisticequation.ui.components.SliderSpinner.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", logisticequation.ui.components.SliderSpinner.class, "getParent", null ); // NOI18N
            properties[PROPERTY_pattern] = new PropertyDescriptor ( "pattern", logisticequation.ui.components.SliderSpinner.class, "getPattern", "setPattern" ); // NOI18N
            properties[PROPERTY_pattern].setPreferred ( true );
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", logisticequation.ui.components.SliderSpinner.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", logisticequation.ui.components.SliderSpinner.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", logisticequation.ui.components.SliderSpinner.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", logisticequation.ui.components.SliderSpinner.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", logisticequation.ui.components.SliderSpinner.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", logisticequation.ui.components.SliderSpinner.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", logisticequation.ui.components.SliderSpinner.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", logisticequation.ui.components.SliderSpinner.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", logisticequation.ui.components.SliderSpinner.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_sliderPosition] = new PropertyDescriptor ( "sliderPosition", logisticequation.ui.components.SliderSpinner.class, "getSliderPosition", "setSliderPosition" ); // NOI18N
            properties[PROPERTY_sliderPosition].setPreferred ( true );
            properties[PROPERTY_step] = new PropertyDescriptor ( "step", logisticequation.ui.components.SliderSpinner.class, "getStep", "setStep" ); // NOI18N
            properties[PROPERTY_step].setPreferred ( true );
            properties[PROPERTY_titulo] = new PropertyDescriptor ( "titulo", logisticequation.ui.components.SliderSpinner.class, "getTitulo", "setTitulo" ); // NOI18N
            properties[PROPERTY_titulo].setPreferred ( true );
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", logisticequation.ui.components.SliderSpinner.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", logisticequation.ui.components.SliderSpinner.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", logisticequation.ui.components.SliderSpinner.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", logisticequation.ui.components.SliderSpinner.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", logisticequation.ui.components.SliderSpinner.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", logisticequation.ui.components.SliderSpinner.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", logisticequation.ui.components.SliderSpinner.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", logisticequation.ui.components.SliderSpinner.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", logisticequation.ui.components.SliderSpinner.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", logisticequation.ui.components.SliderSpinner.class, "getValue", "setValue" ); // NOI18N
            properties[PROPERTY_value].setPreferred ( true );
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", logisticequation.ui.components.SliderSpinner.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", logisticequation.ui.components.SliderSpinner.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", logisticequation.ui.components.SliderSpinner.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", logisticequation.ui.components.SliderSpinner.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", logisticequation.ui.components.SliderSpinner.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", logisticequation.ui.components.SliderSpinner.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", logisticequation.ui.components.SliderSpinner.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( logisticequation.ui.components.SliderSpinner.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addPropertyChangeListener8] = new MethodDescriptor(logisticequation.ui.components.SliderSpinner.class.getMethod("addPropertyChangeListener", new Class[] {java.lang.String.class, java.beans.PropertyChangeListener.class})); // NOI18N
            ...
            methods[METHOD_propertyChange104] = new MethodDescriptor(logisticequation.ui.components.SliderSpinner.class.getMethod("propertyChange", new Class[] {java.beans.PropertyChangeEvent.class})); // NOI18N
